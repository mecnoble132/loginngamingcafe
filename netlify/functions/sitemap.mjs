...
export default async function handler() {
  ...
  if (!process.env.SUPABASE_URL || !process.env.SUPABASE_ANON_KEY) return response(500, '<?xml version="1.0" encoding="UTF-8"?><error>Unavailable</error>');
  ...
  if (error) { console.error('Sitemap query failed', error.message); return response(500, '<?xml version="1.0" encoding="UTF-8"?><error>Unavailable</error>'); }
  ...
  return response(200, `<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">${urls}</urlset>`);
}
