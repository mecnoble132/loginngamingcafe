...
export function renderIndex(posts) {
  ...
  return shell({ title: 'Blog | Loginn Gaming Cafe', description: 'Gaming guides, cafe stories, events, and updates from Loginn Gaming Cafe in Trivandrum.', canonical: `${SITE_URL}/blog`, body: `${hero}<section class="blog-list-section"><div class="container blog-container">${body}</div></section>` });
}
